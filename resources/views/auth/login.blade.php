...
<div style="clear: both;"></div>
<div class="navbar fixed-bottom navbar-expand navbar-dark bg-dark" style="
    color: #fff;
    font-size: 14px;">
    <div style="clear: both;"></div>
  <div class="container-fluid">
      <div class="row" style=" width: 100%;">
            <div class="col-md-6 col-12" style="padding: 4px 5px;">
                <img src="assets/images/logo-2.png" class="img-fluid" style=" margin-top: 4px;float:left; max-width: 42%;">
                <p style="max-width: 54%;margin-left: 10px;float:left; margin-bottom: 4px; padding-top: 0px;">Copyright  2017 - Algo mais gráfica e editora
                    <br>
                Todos os direitos reservados</p>
            </div>
            <div class="col-md-2 col-12" style="padding: 4px 5px;">
            ...
            <div class="col-md-4 col-12" style="padding: 4px 5px;">
